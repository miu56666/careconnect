...
class CareConnecetSupabaseUser extends BaseAuthUser {
  CareConnecetSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> careConnecetSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = CareConnecetSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
