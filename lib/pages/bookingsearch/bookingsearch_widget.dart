...
import 'bookingsearch_model.dart';
export 'bookingsearch_model.dart';

class BookingsearchWidget extends StatefulWidget {
  ...
  @override
  State<BookingsearchWidget> createState() => _BookingsearchWidgetState();
}

class _BookingsearchWidgetState extends State<BookingsearchWidget> {
  late BookingsearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookingsearchModel());
                                              ...
                                              SizedBox(
                                                ...
                                                child: Align(
                                                  ...
                                                  child: wrapWithModel(
                                                    ...
                                                    child: ChoiceWidget(
                                                      key: Key(
                                                        'Keywpw_${(listViewBabysittersRow.cetagory.isNotEmpty).toString()}',
                                                      ),
                                                      parameter1:
                                                          listViewBabysittersRow
                                                              .cetagory,
